    ...
    <div class="row mt-5 mb-5">
        <div class="col-lg-12 margin-tb">
            <div class="float-left">
                <h2>Edit Status Asset</h2>
            </div>
            <div class="float-right">
                <a class="btn btn-success" href="{{ r{{ route('asset.edit',$Asset->asset_approval_id) }} }}">Back</a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td class="text-center">
                <a class="btn btn-primary btn-sm" href="{{ route('asset.edit_asset', $Asset->id) }}">Edit</a> 
            </td>
        </tr>
        @endforeach
    </table>
