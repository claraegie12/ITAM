                ...
                <tr>
                    ...
                    <td class="text-center">
                        @if ($AssetApproval->flag_prucurement == "0")
                            <a class="btn btn-info btn-sm" href="{{ route('procurement.edit', $AssetApproval->id) }}">Details</a>
                        @else
                            <a class="btn btn-success btn-sm" href="{{ route('procurement.show', $AssetApproval->id) }}">Print</a>
                        @endif
                    </td>
                </tr>
                @endforeach
